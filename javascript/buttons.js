...
function fullview(){
	document.getElementById('extent_ajax').value = "355181 268335 1.83347e+06 2.06336e+06";
...
//these 2 functions do the same thing from map.php and map2.php
function login(){
	curr_user_win = window.open("../curr_user_aois.php","w2","menubar=no,scrollbars,width=400,height=600,top=150"); //parent.curr_user_win =
}
function save_aoi(){
	curr_user_win = window.open("","w2","menubar=no,scrollbars,width=400,height=600,top=150");  //parent.
