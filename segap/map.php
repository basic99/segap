 ...
 * Create new map object from $map = ms_newMapObj($mapfile) using segap.map.
...
<td><input type="image" src="/graphics/segap/draw_up.png" id="draw" title="draw custom" onclick="draw()"/> </td>
<td><input  type="image" src="/graphics/segap/info_up.png" id="qry" title="Query" onclick="query()" /> </td>
...
<td><input type="image" src="/graphics/segap/resize_up.png" style="visibility: hidden" /> </td>
<td><input type="image" src="/graphics/segap/bullseye_up.png" title="zoom to co-ordinates" onclick="zoomcoord();" /> </td>
<td><input type="image" src="/graphics/segap/resize_up.png" title="reload frame size of map" onclick="resize();" /> </td>
<td><input type="image" src="/graphics/segap/aoi_up.png" title="Use AOI" onclick="login();" /> </td>
...
<option value="parcel_nam" >parcel name</option>
<option value="man_desc">manage</option>
<option value="own_desc">owner</option>
...
if(isset($user_x)){
	...
	$old_extent->setextent(355181, 268335, 1.83347e+06, 2.06336e+06);
}
...
<input type="hidden" class="aoikeys" name="lcc" id="lcc_aoi" />
...
<input type="hidden" name="lcc"  class="aoikeys" id="lcc_pdf" />
...
<input type="hidden" class="aoikeys" id="lcc_ajax" />
