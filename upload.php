...
function upload(){
   ...
   //opener.parent.gears = window.open("gears.xhtml","","width=400,height=200, top=200, left=200");
   window.close();
}
/* ]]> */
</script>
...
<form id="fm2" enctype="multipart/form-data" action="segap/map2.php" method="post" >
